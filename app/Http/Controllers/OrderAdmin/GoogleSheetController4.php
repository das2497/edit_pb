...
public function updateGoogleSheet()
{
    ...
    $all_shops_grouped = Shops::join('routes', 'shops.evening_route', '=', 'routes.name')
    ...
    Logs::create([
        'type' => 'Refresh Evening Shop Report',
        'message' => 'Ordering admin refreshed evening shop report',
        'user' => Auth::user()->name,
    ]);

    return back()->with('success', 'Successfully updated evening shop report!');
}
