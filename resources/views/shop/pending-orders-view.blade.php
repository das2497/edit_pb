                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="input-group flex-nowrap p-2">
                                    ...
                                    <a class="btn btn-outline-success m-l-10" href="{{route('shop.pending-orders-add-items',['order_number'=>$order_number])}}">
                                        <span class="bi bi-plus-square fs-4"></span> Add product
                                    </a>
                                    <a href="/shop/pending-orders" class="btn btn-outline-danger m-l-10">Go Back</a>
                                </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <form action="/shop/pending-orders-update" method="POST">
                                                        @csrf
                                                        <td><input type="number" class="form-control" value="{{$item->qty}}" name="qty" min="0" step="0.01" required pattern="[0-9]+(\.[0-9]+)?" style="min-width: 100px;"></td>
                                                        ...
                                                        <td><button type="submit" formaction="/shop/pending-orders-delete" onclick="return confirmDelete();" class="btn btn-outline-danger m-l-10">Delete</button></td>
                                                    </form>
                                                </tr>
                                                @php
