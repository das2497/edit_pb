                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form action="/shop/complete-orders" method="GET" class="input-group flex-nowrap p-2">
                                    @csrf
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('shop.complete-orders-view', ['id' => $order->unique_id]) }}" class="btn btn-outline-success">View</a></td>
                                                </tr>
                                                @endforeach
