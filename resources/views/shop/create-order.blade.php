                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @endif
                                <h5 class="card-header">All Products <a href="/shop/cart?shop={{ $my_shop }}" class="btn btn-outline-warning m-l-10 float-right cart-btn"><i class="bi bi-cart4"></i> Cart</a></h5>
                                ...
                                <form action="/shop/create-order" method="GET" class="input-group flex-nowrap p-2">
                                    @csrf
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <form action="{{ route('shop.add-to-cart-all') }}" method="POST">
                                                @csrf
                                                <tbody>
                                                    @if ($errors->any())
                                                    <tr>
                                                    ...
                                                    <tr @if(isset($cart_item) && $cart_item->contains('item_number', $product->item_number)) class="table-success" @endif>
                                                        ...
                                                        <td><img class="img-thumbnail" src="{{ asset('assets/images/item-images/'.$product->img) }}" style="width: 100px; height: 100px;" /></td>
                                                        <td>{{ $product->item_number }}</td>
                                                        <td>{{ $product->name_english }}</td>
                                                        <td>රු. {{ number_format($product->unit_price, 2) }}</td>
                                                        <td>
