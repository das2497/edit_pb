            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> Pending Orders View </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/order-admin/dashboard" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Pending Orders View</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Pending Orders View</h5>
                                <div class="p-3">
                                    <span>Shop : {{$shop_name}}</span> &nbsp; | &nbsp;
                                    <span>Time Period : {{$time_period}}</span> &nbsp; | &nbsp;
                                    <span>Note : {{$note}}</span>
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="input-group flex-nowrap p-2">
                                    ...
                                    <a class="btn btn-outline-success m-l-10" href="{{route('rep.pending-orders-add-items',['order_number'=>$order_number])}}">
                                        <span class="bi bi-plus-square fs-4"></span> Add product
                                    </a>
                                    <a href="/rep/pending-order" class="btn btn-outline-danger m-l-10">Go Back</a>
                                </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <form action="/rep/pending-orders-update" method="POST">
                                                        @csrf
                                                        ...
                                                        <td><button type="submit" formaction="/rep/pending-orders-delete" onclick="return confirmDelete();" class="btn btn-outline-danger m-l-10">Delete</button></td>
                                                    </form>
                                                </tr>
                                                @php
                                                ...
                                                <tr>
                                                    <td colspan="7"></td>
                                                    <th>
                                                        <form action="/rep/pending-orders-accept" method="POST">
                                                            @csrf
