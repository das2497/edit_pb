...
@section('title', 'Rep | Pending Orders View')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    <div>
        ...
        <div class="page-sub">Shop: {{ $shop_name }} | Period: {{ $time_period }} | Note: {{ $note ?: '—' }} | Order: <span class="mono">{{ $order_number }}</span></div>
    </div>
    <div class="d-flex gap-2">
        <a class="btn btn-accent" href="{{ route('rep.pending-orders-add-items', ['order_number' => $order_number]) }}">
            <i class="bi bi-plus-square me-1"></i> Add product
        </a>
        <a href="/rep/pending-order" class="btn btn-soft">Go Back</a>
    </div>
</div>
...
<div class="panel">
    <div class="panel-head">
        <div>
            <h2>Order Items</h2>
            <div class="sub">Update quantity / remark, or delete</div>
        </div>
    </div>
        ...
        <table class="table table-bakery align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="/rep/pending-orders-update" method="POST" id="{{ $fid }}">
                            @csrf
                    ...
                    <td><button type="submit" form="{{ $fid }}" formaction="/rep/pending-orders-delete" onclick="return confirmDelete();" class="btn btn-soft btn-sm" style="color:var(--accent);">Delete</button></td>
                </tr>
