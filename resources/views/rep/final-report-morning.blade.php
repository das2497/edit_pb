...
@section('title', 'Final Morning Report | Rep')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
        <a class="btn btn-soft" href="/rep/final-report-evening">Evening Report</a>
        <a class="btn btn-accent" href="/rep/final-report-morning-full-screen">Full Screen</a>
    </div>
</div>
