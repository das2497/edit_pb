...
@section('title', 'Morning Shop Report | Rep')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
        <a class="btn btn-soft" href="/rep/shop-report-evening">Evening Report</a>
        <a class="btn btn-accent" href="/rep/shop-report-full-screen">Full Screen</a>
    </div>
</div>
