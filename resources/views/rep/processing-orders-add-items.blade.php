            ...
            <div class="container-fluid dashboard-content ">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> Processing Orders Add Items </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/order-admin/dashboard" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Processing Orders Add Items</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Processing Orders Add Items <a href="/rep/processing-orders-view/{{$order_number}}" class="btn btn-outline-danger m-l-10 float-right">Go Back</a></h5>
                                @if ($errors->any())
                                ...
                                <div class="input-group flex-nowrap p-2">
                                    <form action="/rep/processing-orders-add-item" method="GET" class="input-group flex-nowrap p-2">
                                        @csrf
                                        <input type="text" class="form-control mr-2" id="" placeholder="Search items" aria-describedby="addon-wrapping" name="search">
                                            ...
                                            <tbody>
                                                ...
                                                <tr @if(isset($cart_items) && $cart_items->contains('item_number', $product->item_number)) class="table-success" @endif>
                                                    ...
                                                    <form action="{{route('rep.processing-orders-add-items-process')}}" method="POST">
                                                        @csrf
                                                        <input class="form-control" type="number" min="0" step="0.01" required pattern="[0-9]+(\.[0-9]+)?" value="0" style="min-width: 100px;" name="qty">
