...
@section('title', 'Final Evening Report | Rep')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    <div>
        <h1 class="display-font page-title mb-1">Final Evening Report</h1>
        <div class="page-sub">Dashboard / Final Evening Report</div>
    </div>
    <div class="d-flex gap-2">
        <a class="btn btn-soft" href="/rep/final-report-morning">Morning Report</a>
        <a class="btn btn-accent" href="/rep/final-report-evening-full-screen">Full Screen</a>
    </div>
</div>
...
<div class="panel">
    <div class="panel-head">
        <div>
            <h2>Today Evening Final Report</h2>
