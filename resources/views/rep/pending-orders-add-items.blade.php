...
@section('title', 'Rep | Pending Orders Add Items')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    ...
    <div>
        <a href="/rep/pending-orders-view/{{ $order_number }}" class="btn btn-soft">Go Back</a>
    </div>
</div>
...
<div class="panel">
    ...
    <form action="/rep/pending-orders-add-item" method="GET" class="d-flex flex-wrap gap-2 mb-3">
        ...
        <table class="table table-bakery align-middle">
            ...
            <tbody>
                ...
                <tr @if($inCart) class="in-cart" @endif>
                    ...
                    <td>
                        <form action="{{ route('rep.pending-orders-add-items-process') }}" method="POST" id="{{ $fid }}">
                            @csrf
