...
@section('title', 'Rep | Under Review Add Items')

@section('content')

<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    <div>
        <h1 class="display-font page-title mb-1">Under Review — Add Items</h1>
        <div class="page-sub">Order: <span class="mono">{{ $order_number }}</span> / Add Items</div>
    </div>
    <div>
        <a href="/rep/under-review-orders-view/{{ $order_number }}" class="btn btn-soft">Go Back</a>
    </div>
</div>
...
<div class="panel">
    ...
    <form action="/rep/under-review-orders-add-item" method="GET" class="d-flex flex-wrap gap-2 mb-3">
        ...
        <table class="table table-bakery align-middle">
            ...
            <tbody>
                ...
                <tr @if($inCart) class="in-cart" @endif>
                    ...
                    @else
                    @php $fid = 'add-ur-'.$loop->iteration; @endphp
                    ...
                    <td>
                        <form action="{{ route('rep.under-review-orders-add-items-process') }}" method="POST" id="{{ $fid }}">
                            @csrf
