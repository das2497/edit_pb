            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Under Review Orders Add Items <a href="/rep/under-review-orders-view/{{$order_number}}" class="btn btn-outline-danger m-l-10 float-right">Go Back</a></h5>
                                @if ($errors->any())
                                ...
                                <div class="input-group flex-nowrap p-2">
                                    <form action="/rep/under-review-orders-add-item" method="GET" class="input-group flex-nowrap p-2">
                                        @csrf
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr @if(isset($cart_items) && $cart_items->contains('item_number', $product->item_number)) class="table-success" @endif>
                                                    ...
                                                    <td>
                                                    <td><button class="btn btn-outline-success disabled">Add item to Under Review orders</button></td>
                                                    </td>
                                                    @else
                                                    <form action="{{route('rep.under-review-orders-add-items-process')}}" method="POST">
                                                        @csrf
                                                        <input class="form-control" min="0" step="0.01" required pattern="[0-9]+(\.[0-9]+)?" type="number" name="qty">
                                                        <input type="hidden" name="order_number" value="{{ $order_number }}">
                                                        <input type="hidden" name="item_number" value="{{ $product->item_number }}">
                                                        <input type="hidden" name="shop" value="{{ $shop }}">
                                                        <td>
                                                        <td><button type="submit" class="btn btn-outline-success">Add item to Under Review orders</button></td>
                                                        </td>
                                                    </form>
                                                    @endif
                                                </tr>
