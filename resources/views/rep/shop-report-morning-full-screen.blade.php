...
@section('title', 'Morning Shop Report - Full Screen | Rep')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    <div>
        <h1 class="display-font page-title mb-1">Morning Shop Report - Full Screen</h1>
        <div class="page-sub">Rep / Full Screen Shop Report</div>
    </div>
    <div class="d-flex gap-2">
        <a href="/rep/shop-report-morning" class="btn btn-soft btn-sm"><i class="bi bi-arrow-left me-1"></i> Back to Report</a>
...
<div class="panel">
    <div class="panel-head">
        <div>
            <h2>Morning Shop Report - Full Screen</h2>
