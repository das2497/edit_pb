                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @endif
                                <form action="{{ route('rep.complete-order') }}" method="GET" class="input-group flex-nowrap p-2">
                                    @csrf
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('rep.complete-orders-view', ['id' => $order->unique_id]) }}" class="btn btn-outline-success">View</a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
