                ...
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4 d-grid">
                            <a class="btn btn-outline-primary mb-4" href="/rep/shop-report-morning">Morning Report</a>
                        </div>
                        <!-- ============================================================== -->
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <h5 class="card-header">Today Evening Shop Report &nbsp;&nbsp;
                                            <a href="/rep/shop-report-full-screen-evening" type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#morning_shop_wise_report">
                                                Full Screen
                                            </a>
                                        </h5>
                                    </div>
