            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Pending Orders Add Items <a href="/order-admin/pending-orders-view/{{$order_number}}" class="btn btn-outline-danger m-l-10 float-right">Go Back</a></h5>
                                @if ($errors->any())
                                ...
                                <div class="input-group flex-nowrap p-2">
                                    <form action="/order-admin/pending-orders-add-item" method="GET" class="input-group flex-nowrap p-2">
                                        @csrf
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr @if(isset($cart_items) && $cart_items->contains('item_number', $product->item_number)) class="table-success" @endif>
                                                    ...
                                                    @else
                                                    <form action="{{route('order-admin-pending-orders-add-items-process')}}" method="POST">
                                                        @csrf
