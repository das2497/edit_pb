                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="/order-admin/create-order?shop={{session('selected_shop')}}" class="breadcrumb-link">Create Order</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="card">
                                ...
                                @endif
                                <h5 class="card-header">{{$shop->name}}'s Cart {{session('selected_shop')}}<a href="/order-admin/create-order?shop={{session('selected_shop')}}" class="btn btn-outline-danger float-right">Go Back</a></h5>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{asset('assets/images/item-images/'.$cart->img)}}" class="img-thumbnail" alt="product image" style="width: 80px; height: 80px;"></td>
                                                    <td>{{$cart->item_number}}</td>
                                                    <td>{{$cart->name_english}}</td>
                                                    <td>{{$cart->price_range}}</td>
                                                    <td>රු. {{number_format($cart->price,2)}}</td>
                                                    <form action="/order-admin/cart/update-qty" method="POST">
                                                        @csrf
                                                        <td><input type="number" name="qty" class="form-control" min="0" step="0.01" required pattern="[0-9]+(\.[0-9]+)?" value="{{$cart->qty}}"></td>
                                                        <td><input type="text" class="form-control" name="remarke" value="{{$cart->remarke}}"></td>
                                                        ...
                                                        <td><button type="submit" formaction="/order-admin/cart/delete-item" onclick="return confirmDelete();" class="btn btn-outline-danger">Delete</button></td>
                                                    </form>
                                                </tr>
                                                @php
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body p-1">
                                    <form action="/order-admin/cart/order-process" method="POST" class="row">
                                        @csrf
