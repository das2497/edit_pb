...
<head>
    ...
    <title>Order Admin | Pending Orders View</title>
            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Pending Orders View <div>Note : {{$order_note}}</div>
                                </h5>
                                @if ($errors->any())
                                ...
                                <div class="input-group flex-nowrap p-2">
                                    ...
                                    <a class="btn btn-outline-success m-l-10" href="{{route('order-admin-pending-orders-add-items',['order_number'=>$order_number])}}">
                                        <span class="bi bi-plus-square fs-4"></span> Add product
                                    </a>
                                    @endif
                                    <a href="/order-admin/pending-orders" class="btn btn-outline-danger m-l-10">Go Back</a>
                                </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$item->item_number}}</td>
                                                    <td>{{$item->name_english}}</td>
                                                    <form action="/order-admin/pending-orders-update" method="POST">
                                                        @csrf
                                                        ...
                                                        <td><button type="submit" formaction="/order-admin/pending-orders-delete" onclick="return confirmDelete();" class="btn btn-outline-danger m-l-10">Delete</button></td>
                                                </tr>
                                                @php
                                                $total += $item->price*$item->qty;
                                                @endphp
