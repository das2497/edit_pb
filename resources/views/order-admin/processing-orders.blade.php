                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                @endif
                                <form action="/order-admin/processing-orders" method="GET" class="input-group flex-nowrap p-2">
                                    @csrf
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('order-admin-processing-orders-view', ['id' => $order->unique_id ,'note'=>$order->note]) }}" class="btn btn-outline-success">View</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            ...
                                            <tbody>
                                                @foreach ($Orders as $order)
                                                <tr>
                                                    <form action="/order-admin/processing-orders-update-order" method="POST">
                                                        @csrf
                                                        <td>{{ $loop->iteration}}</td>
                                                        <td>{{ $order->unique_id }}</td>
                                                        <td>{{ $order->name }}</td>
