...
@section('title', 'Complete Orders View | Perera Bakers')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    <div>
        ...
        <div class="page-sub"><span class="mono">{{ $order_number }}</span> | {{ $order_created }} | {{ $shop }}</div>
    </div>
    <div>
        <a href="/order-admin/complete-orders" class="btn btn-soft">Go Back</a>
    </div>
</div>
...
<div class="panel">
    <div class="panel-head">
        <div>
            <h2>Order Items</h2>
            <div class="sub">{{ count($items) }} item(s)</div>
        </div>
    </div>
