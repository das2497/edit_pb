...
@section('title', 'Final Evening Report | Perera Bakers')
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
        <a class="btn btn-soft" href="/order-admin/final-report">Morning Report</a>
        <a class="btn btn-accent" href="/order-admin/final-report-evening-full-screen">Full Screen</a>
    </div>
</div>
